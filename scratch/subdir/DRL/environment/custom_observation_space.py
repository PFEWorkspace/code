...
# import flatdict
# total_nodes = 4
# space = CustomObservationSpace(total_nodes)
# obs = space.sample()
# flat_obs = space.preprocess_observation(obs['current_state'], np.array([obs['FL_accuracy']]))
# print ("obs : ",obs)
# print("obs shape :" , obs["current_state"].shape)
# print("obs shape :", obs["FL_accuracy"].shape)
# print("flat : ",flat_obs)
# print("flat shape :",flat_obs.shape)
# print(obs)
# d =  flatdict.FlatDict(obs, delimiter='.')
# print(d.shape)
