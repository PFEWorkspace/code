...
import numpy as np
import gym
from node_selection_env import FLNodeSelectionEnv  # Replace with your actual module name
from node_selection_agent import Agent  # Replace with your actual module name
...
for episode in range(num_episodes):
    ...
    while not done:
        ...
        next_observation, reward, done, _ = env.step(action, act)  # Take the chosen action
